...
class BoletoFacil
{
    ...
    public function refundCreditCardPayment()
    {
        ...
        return $this->request('refund-credit-card-payment', $requestData);
    }

    public function cardTokenization()
    {
